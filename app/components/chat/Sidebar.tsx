      ...
      <AnimatePresence>
        {expanded && (
          <motion.div
            ...
            className="z-50 flex flex-col h-full w-64 border-r border-gray-200 dark:border-gray-800 bg-background/95 backdrop-blur-md fixed left-0 top-0 bottom-0 shadow-xl"
          >
