...
export default function CancellationLayout({
  ...
  return (
    <section className="flex flex-col items-center  h-full gap-4 py-8 md:py-10 p-4 pb-24 max-h-[100dvh] overflow-y-auto">
      <div className="inline-block max-w-5xl text-center  w-full">
        {children}
      </div>
    </section>
  );
